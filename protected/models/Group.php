...
class Group extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('GRP_NAME', 'length', 'max'=>45),
			array('GRP_DESCRIPTION, _CREATED', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, GRP_NAME, GRP_DESCRIPTION, _CREATED', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'members' => array(self::HAS_MANY, 'Member', 'GRP_ID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('GRP_DESCRIPTION',$this->GRP_DESCRIPTION,true);
